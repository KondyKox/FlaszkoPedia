              ...
              <li
                ...
                className={`cursor-pointer transition-colors duration-300 ease-in-out ${
                  sortBy === option.value
                    ...
                    : "text-primary"
                } rounded-lg p-2 flex-1 border border-slate-300`}
              >
                {option.label}
              </li>
            ))}
          ...
          >
            {SORT_ASCENDING_OPTIONS.map((option, index) => (
              <li
                ...
                className={`flex flex-col justify-center items-center cursor-pointer transition-colors duration-300 ease-in-out ${
